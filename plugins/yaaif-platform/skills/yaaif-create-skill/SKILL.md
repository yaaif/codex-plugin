...
description: >-
  ...
  via the yaaif Codex MCP bridge. Use when Admin UI Open in Codex / Create in
  Codex selected a skill_id, or when creating a new skill. Prefers platform
...
If the prompt includes `skill_id` from Admin UI, stay in Codex — do not open
